...
newEnemy = enemy(pygame.image.load(r'./assets/images/characters/enemy.png'), 10, SCREENWIDTH/2+180, 60, 50, 50, SCREENWIDTH, SCREENHEIGHT, player) # def __init__(self, image : pygame.Surface, x : int, y : int, width : int, height : int, screenWidth : int, screenHeight : int)
